...
while (success == 0)
   ...
   if (returnCode ==0)
        ...
        success = 1;
         batteries = {time battery battery2 battery3 battery4 battery5 battery6 battery7 battery8 battery9 battery10 battery11 battery12 battery13 battery14 battery15 battery16};
